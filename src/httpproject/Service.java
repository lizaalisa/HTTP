...
//    private Object welcomeSocket;
    ...
    public void run() {
        ...
        try {
            ...
            ReadingRequest requestline = new ReadingRequest(clientSentence);
            MyLogger.logger.log(Level.FINEST, "Request from client received");
           
            System.out.println(requestline.filename);
            if (requestline.command.equals("GET")) {
                FileInputStream file = new FileInputStream(new File(ROOT_CATALOG + requestline.filename));
